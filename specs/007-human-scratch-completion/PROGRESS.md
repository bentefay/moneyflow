...
| P21     | control        | [Executable final audit](tasks/P21-final-audit.md)                                  | all prior            | implementing | 01  | BASE (last integration) `4c20206`; collector at HEAD `3b6a6b6` (delta = root dispatch docs only; product range empty)  | `evidence/P21/implementation-01.md` (dispatched)                                                                 | `reviews/P21-review-01.md` (future, distinct) | —                                                                                                               |
