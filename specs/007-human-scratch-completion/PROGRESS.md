...
| P21     | control        | [Executable final audit](tasks/P21-final-audit.md)                                  | all prior            | implementing | 01  | BASE == HEAD `4c20206` (empty range expected)                                                                          | `evidence/P21/implementation-01.md` (dispatched)                                                                 | `reviews/P21-review-01.md` (future, distinct) | —                                                                                                               |
