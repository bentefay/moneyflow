...
| P21     | control        | [Executable final audit](tasks/P21-final-audit.md)                                  | all prior            | reviewing | 01  | BASE (last product commit) `4c20206`; product range EMPTY (delta 4c20206..HEAD = root control-plane only: ledgers + evidence/P21) | `evidence/P21/implementation-01.md` (persisted `d952cdc`; collector FAIL-candidate)                              | `reviews/P21-review-01.md` (dispatched, distinct) | collector FAIL-candidate: NEW E2E hydration flake `identity.spec.ts:282` (run #1 1-fail/162-pass, run #2 clean); reviewer to render formal PASS/FAIL |
