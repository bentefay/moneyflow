...
- **Goal status:** scaffolded, not started
- **Current package:** none
- **Next action:** root fills the P00 literal handoff, dispatches its evidence collector and
  independent revision-01 reviewer, transcribes a PASS baseline, then dispatches P01
...
- **Last ledger update:** 2026-07-19 scaffold creation

## Package ledger

| Package | Scope          | Work / task                                                                         | Depends on           | Status | Rev | BASE..HEAD | Implementation evidence | Review | Integration commit |
| ------- | -------------- | ----------------------------------------------------------------------------------- | -------------------- | ------ | --- | ---------- | ----------------------- | ------ | ------------------ |
| P00     | control        | [Executable baseline](tasks/P00-baseline.md)                                        | —                    | queued | —   | —          | —                       | —      | —                  |
