...
- **Current package:** P00 revision 02 (`reviewing`)
- **Next action:** root persists the independently approved revision-02 evidence/review and
  baseline, risk and decision transcriptions in an exact-path integration-control commit; only after
  recording that commit may P00 become `passed`
...
- **Last ledger update:** 2026-07-20T00:38:03+10:00; P00 revision 02 independent PASS verified at
  review SHA-256 `0f5129c9e2068cc0b8939ac27ec224b1843b34c613e6c951b0864bf81abe82f6`; root
  integration/transcription is in progress and P00 is not yet passed

## Package ledger

| Package | Scope          | Work / task                                                                         | Depends on           | Status    | Rev | BASE..HEAD                                                                           | Implementation evidence             | Review                     | Integration commit |
| ------- | -------------- | ----------------------------------------------------------------------------------- | -------------------- | --------- | --- | ------------------------------------------------------------------------------------ | ----------------------------------- | -------------------------- | ------------------ |
| P00     | control        | [Executable baseline](tasks/P00-baseline.md)                                        | —                    | reviewing | 02  | `0ea864f5d0142530b2d524add228d3b51f162876..8f12d82ddb576af5cc8c6f04d32617d805e300de` | `evidence/P00/implementation-02.md` | `reviews/P00-review-02.md` | pending            |
