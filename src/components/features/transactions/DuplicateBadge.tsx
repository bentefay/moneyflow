...
export function DuplicateBadge({
    ...
    return (
        <div className={cn("relative inline-flex", className)}>
            ...
            {/* Tooltip - rendered in portal with fixed positioning */}
            {showTooltip &&
                            ...
                            {onResolve && (
                                <div className="mt-3 flex gap-2 border-t pt-2">
                                    <button
                                        ...
                                        className="flex-1 rounded bg-green-100 px-2 py-1 text-xs font-medium text-green-700 hover:bg-green-200 dark:bg-green-900/30 dark:text-green-400"
                                    >
                                        Keep Both
                                    </button>
                                    <button
                                        ...
                                        className="flex-1 rounded bg-red-100 px-2 py-1 text-xs font-medium text-red-700 hover:bg-red-200 dark:bg-red-900/30 dark:text-red-400"
                                    >
                                        Delete This
                                    </button>
                                </div>
