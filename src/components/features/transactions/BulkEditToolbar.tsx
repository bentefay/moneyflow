        ...
        >
            <div className="flex items-center gap-2 px-4 py-3">
                ...
                {progress ? (
                    ...
                    <span className="text-sm font-medium text-nowrap">Edit {selectedCount}</span>
                )}
                ...
                {onSetNotes && (
                    <div className="relative">
                        <button
                            ...
                            onClick={() =>
                                setActiveDropdown(activeDropdown === "notes" ? null : "notes")
                            }
                            disabled={!!progress}
                            className={cn(
                                "flex items-center gap-1.5 rounded-md px-3 py-1.5 text-sm",
                        ...
                        {activeDropdown === "notes" && (
                            <div
                                className="bg-popover absolute bottom-full left-0 mb-2 w-64 rounded-lg border p-3 shadow-lg"
                ...
                {onSetAmount && (
                    <div className="relative">
                        <button
                            type="button"
                            onClick={() =>
                                setActiveDropdown(activeDropdown === "amount" ? null : "amount")
                            }
                            disabled={!!progress}
                            className={cn(
                                "flex items-center gap-1.5 rounded-md px-3 py-1.5 text-sm",
                        ...
                        {activeDropdown === "amount" && (
                            <div
                                className="bg-popover absolute bottom-full left-0 mb-2 w-48 rounded-lg border p-3 shadow-lg"
                                onKeyDown={handleKeyDown}
                            >
                                <div className="relative">
                                ...
                                <div className="mt-2 flex justify-end gap-2">
                                    ...
                                    <Button
                                        ...
                                        disabled={
                                            !amountValue ||
                                            Number.isNaN(Number.parseFloat(amountValue))
                                        }
                                    >
                                        Apply
                                    </Button>
