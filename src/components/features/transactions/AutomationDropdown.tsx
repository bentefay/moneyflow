            ...
            <div className="grid gap-3">
                ...
                >
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="text-muted-foreground text-sm">
                            When you edit a transaction&apos;s tags, status, or allocations,
                            you&apos;ll be offered to create an automation rule that applies the
                            same changes to similar transactions.
                        </p>
                    </div>
                </label>
                ...
                >
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="text-muted-foreground text-sm">
                            Create automations manually from the Automations page. Edits to
                            transactions won&apos;t prompt you to create rules.
                        </p>
                    </div>
                </label>
            </div>
