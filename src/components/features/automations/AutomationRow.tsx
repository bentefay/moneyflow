...
import type { Automation, Tag, Status, Person } from "@/lib/crdt/schema";
import { ConditionEditor, type ConditionData } from "./ConditionEditor";
import { ActionEditor, type ActionData } from "./ActionEditor";
...
export function AutomationRow({
  ...
  return (
    <div
      className={cn("group rounded-md border", isEditing && "ring-primary ring-2", className)}
      ...
      {isExpanded && (
        <div className="space-y-4 border-t px-3 pt-3 pb-3">
          ...
          <div className="space-y-2">
            <div className="text-sm font-medium">When transaction matches:</div>
            {isEditing ? (
              <>
          ...
          {/* Actions */}
          <div className="space-y-2">
            <div className="text-sm font-medium">Then apply:</div>
            {isEditing ? (
              <>
