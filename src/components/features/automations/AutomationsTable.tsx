...
import type { Automation, AutomationInput, Tag, Status, Person } from "@/lib/crdt/schema";
...
export function AutomationsTable({ className }: AutomationsTableProps) {
  ...
  return (
    <div className={className}>
      ...
      {isCreating ? (
        <div className="bg-muted/50 mt-4 flex items-center gap-3 rounded-md px-3 py-2">
