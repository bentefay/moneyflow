...
export function Footer() {
	return (
		<footer className="border-zinc-200 border-t bg-white dark:border-zinc-800 dark:bg-zinc-950">
				...
				<div className="xl:grid xl:grid-cols-3 xl:gap-8">
					...
					<div className="space-y-4">
						<Link href="/" className="flex items-center gap-2">
							...
							<span className="font-semibold text-lg text-zinc-900 dark:text-white">MoneyFlow</span>
						</Link>
					...
					<div className="mt-16 grid grid-cols-3 gap-8 xl:col-span-2 xl:mt-0">
						<div>
							<h3 className="font-semibold text-sm text-zinc-900 dark:text-white">Product</h3>
						...
						<div>
							<h3 className="font-semibold text-sm text-zinc-900 dark:text-white">Resources</h3>
							<ul className="mt-4 space-y-3">
						...
						<div>
							<h3 className="font-semibold text-sm text-zinc-900 dark:text-white">Community</h3>
							<ul className="mt-4 space-y-3">
