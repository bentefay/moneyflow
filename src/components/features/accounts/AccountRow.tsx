...
export function AccountRow({
    ...
    const exitEditMode = useCallback(
        (e: React.MouseEvent) => {
            ...
            const newNumber = editedAccountNumber.trim() || undefined;
            if (newNumber !== (account.accountNumber || undefined))
                updates.accountNumber = newNumber;
    ...
    return (
        ...
        >
            ...
            >
                    ...
                    {editingField === "accountNumber" || isEditMode ? (
                        <div onClick={(e) => e.stopPropagation()}>
                            <Input
                                ...
                                onKeyDown={(e) =>
                                    !isEditMode && handleKeyDown(e, saveAccountNumber)
                                }
                ...
                <div className="w-28 shrink-0">
                    {editingField === "type" || isEditMode ? (
                        <select
                            ...
                            className="border-input bg-background h-8 w-full appearance-none rounded-md border bg-[url('data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20fill%3D%22none%22%20viewBox%3D%220%200%2020%2020%22%3E%3Cpath%20stroke%3D%22%236b7280%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%20stroke-width%3D%221.5%22%20d%3D%22m6%208%204%204%204-4%22%2F%3E%3C%2Fsvg%3E')] bg-[length:1.25rem] bg-[right_0.25rem_center] bg-no-repeat px-2 pr-6 text-sm"
                        >
                ...
                {/* Currency */}
                <div
                    className="w-32 shrink-0 text-center text-sm"
                    onClick={(e) => e.stopPropagation()}
                >
                    {editingField === "currency" || isEditMode ? (
                        ...
                        >
                            {resolvedCurrency}
                            {isInherited && (
                                <span className="text-muted-foreground/60 text-xs">(default)</span>
                            )}
                        </span>
                    )}
                </div>
                ...
                {/* Owners */}
                <div className="text-muted-foreground hidden w-32 shrink-0 truncate text-sm md:block">
