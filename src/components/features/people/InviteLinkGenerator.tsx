...
import { Check, Clock, Copy, Link2, Loader2 } from "lucide-react";
...
export function InviteLinkGenerator({
    ...
    const handleGenerate = useCallback(async () => {
        ...
        try {
            ...
            // 5. Create invite URL with secret in fragment
            const inviteSecretBase64 = sodium.to_base64(
                inviteSecret,
    ...
    return (
        <Card className={cn("w-full", className)}>
            <CardHeader>
                ...
                <CardDescription>
                    Generate a link to invite someone to this vault. The link contains a secret that
                    allows them to decrypt the vault key.
                </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                    <div className="space-y-2">
                        ...
                        <Select
                            value={role}
                            onValueChange={(v: string) => setRole(v as "member" | "owner")}
                        >
