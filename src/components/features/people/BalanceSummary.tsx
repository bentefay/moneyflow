...
import type { Person, Transaction, Status } from "@/lib/crdt/schema";
  ...
  if (significantBalances.length === 0) {
    return (
      <Card className={cn("w-full", className)}>
        ...
        <CardContent>
          <p className="text-muted-foreground text-center text-sm">🎉 Everyone is settled up!</p>
        </CardContent>
      </Card>
    );
  }
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  involvesCurrentUser(balance) && "bg-accent/50 border-primary/20"
                )}
              >
