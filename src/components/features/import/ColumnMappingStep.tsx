			...
			<div className="rounded-lg border">
				<table className="w-full">
					<thead className="border-b bg-muted/50">
						<tr>
							<th className="px-4 py-2 text-left font-medium text-sm">Your Column</th>
							<th className="px-4 py-2 text-left font-medium text-sm">Sample Data</th>
							<th className="px-4 py-2 text-left font-medium text-sm">Maps To</th>
						</tr>
					</thead>
