            ...
            return existingTransactions.some(
                (existing) =>
                    ...
                    (existing.description
                        ...
                        description
                            .toLowerCase()
                            .includes(existing.description.toLowerCase().substring(0, 10)))
            );
        },
        [existingTransactions]
    );
                    ...
                    <div className="py-12 text-center">
                        ...
                        {stats.duplicates > 0 && (
                            <p className="mt-2 text-sm text-yellow-600">
                                {stats.duplicates} potential duplicate
                                {stats.duplicates !== 1 ? "s" : ""} flagged for review.
                            </p>
                        )}
                    </div>
                );
            ...
            {step !== "complete" && (
                <div className="mt-6 flex justify-between">
                    ...
                    <button
                        ...
                        className="bg-primary text-primary-foreground hover:bg-primary/90 disabled:bg-muted disabled:text-muted-foreground rounded px-4 py-2 text-sm font-medium transition-colors"
                    >
