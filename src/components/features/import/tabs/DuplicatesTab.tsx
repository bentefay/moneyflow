            ...
            <div className="space-y-4">
                ...
                <div className="space-y-3 rounded-lg border p-4">
                    ...
                    >
                        <label
                            htmlFor="date-exact"
                            className="hover:bg-muted/30 flex cursor-pointer items-center space-x-3 rounded-md transition-colors"
                        >
                    ...
                    {duplicateDetection.dateMatchMode === "within" && (
                        <div className="border-muted ml-2 space-y-2 border-l-2 pl-6">
                            <div className="flex items-center justify-between text-sm">
                                <span className="text-muted-foreground">Allow dates within:</span>
                                <span className="font-medium">
                                    {duplicateDetection.maxDateDiffDays} days
                                </span>
                            </div>
                            <Slider
