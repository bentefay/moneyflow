            ...
            {duplicateCount > 0 && (
                <div className="rounded-lg border border-yellow-500/50 bg-yellow-50 p-3 dark:bg-yellow-950/20">
                    <p className="text-sm text-yellow-700 dark:text-yellow-400">
                        <strong>{duplicateCount}</strong> potential duplicate
                        {duplicateCount !== 1 ? "s" : ""} detected. These will be imported but
                        flagged for review.
                    </p>
                </div>
            )}
            ...
            {errorCount > 0 && (
                <div className="rounded-lg border border-red-500/50 bg-red-50 p-3 dark:bg-red-950/20">
                    <p className="text-sm text-red-700 dark:text-red-400">
                        <strong>{errorCount}</strong> row{errorCount !== 1 ? "s" : ""} will be
                        skipped due to errors. Check the formatting settings if this is unexpected.
                    </p>
                </div>
            )}
