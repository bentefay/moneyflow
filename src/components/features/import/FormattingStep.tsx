	...
	return (
		<div className={cn("space-y-6", className)}>
			<div className="flex items-center justify-between">
				<div>
					<h3 className="font-semibold text-lg">Format Options</h3>
					<p className="text-muted-foreground text-sm">Configure how to parse dates and numbers</p>
				</div>
				<button
					type="button"
					onClick={autoDetect}
					className="rounded px-3 py-1.5 font-medium text-sm transition-colors hover:bg-accent"
				>
					Auto-detect
				</button>
			</div>
			...
			<div className="space-y-2">
				<label className="font-medium text-sm">Date Format</label>
				<select
			...
			<div className="grid gap-4 sm:grid-cols-2">
				<div className="space-y-2">
					<label className="font-medium text-sm">Thousands Separator</label>
					<select
				...
				<div className="space-y-2">
					<label className="font-medium text-sm">Decimal Separator</label>
					<select
			...
			<div className="space-y-3">
				<label className="font-medium text-sm">Amount Options</label>
