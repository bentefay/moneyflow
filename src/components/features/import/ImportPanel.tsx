    ...
    if (!session) {
        return (
            <div className={cn("flex flex-col items-center justify-center p-8", className)}>
                ...
                />
                {error && <p className="text-destructive mt-2 text-sm">{error.message}</p>}
            </div>
        );
    }
        ...
        <div className={cn("flex flex-col gap-4", className)}>
                    ...
                    >
                        {isImporting ? (
                            ...
                            <>
                                ...
                                Import {summaryStats.validCount + summaryStats.duplicateCount}{" "}
                                Transactions
                            </>
                        )}
                    </Button>
            ...
            <div className="flex flex-wrap gap-4">
                ...
                <ImportTable
                    ...
                    className="min-h-[400px] min-w-0 flex-1 lg:min-w-[500px]"
                />
                ...
                <ConfigTabs
                    ...
                    fileType={session.fileType}
                    className="h-fit w-full lg:w-[350px] lg:shrink-0"
                >
                    {/* Template Tab */}
