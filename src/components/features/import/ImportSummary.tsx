...
function StatCard({ label, value, icon: Icon, iconColor, bgColor, detail }: StatCardProps) {
    return (
        ...
        >
            <div className={cn("bg-muted/50 rounded-full p-2", iconColor)}>
            ...
            <div className="flex flex-col">
                ...
                {detail && (
                    <span className="text-muted-foreground/70 mt-0.5 text-xs">{detail}</span>
                )}
            </div>
        </div>
    );
                ...
                {canImport ? (
                    ...
                    <p className="text-sm text-amber-800 dark:text-amber-200">
                        {needsAccountSelection ? (
                            ...
                            <>
                                No valid transactions found. Please check your column mappings and
                                formatting settings.
                            </>
                        ) : willImportCount === 0 ? (
                            <>
