    ...
    return (
        <div className={cn("space-y-6", className)}>
            ...
            <div className="text-muted-foreground text-sm">
                <p>
                    <strong>Tip:</strong> Use hierarchical tags (e.g., Food → Groceries, Food →
                    Restaurants) to organize categories. Mark tags as &quot;Transfer&quot; to
                    exclude internal money movements from expense reports.
                </p>
            </div>
        </div>
    );
